...
Ifa is a customizable paginator for aspnet mvc 3.

== Install

On your aspnet mvc 3 project instal using Nuget:
  install-package Ifa
...
Inside that folder you can create on partial view for each Ifá Paginator type:
...
So with I want to change the HTML for my current page, I have to create a partial view named CurrentPage.cshtml in Views/Shared/Ifa. My view code could looks like this one:
